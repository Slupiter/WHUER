<template>
    <view class="page">
        ...
        <view class="feedback-body">
            <input class="feedback-input" v-model="sendDate.title" placeholder="必填" />
        </view>
		 <view class='feedback-title'>
		    <text>内容</text>
		</view>
		 <view class="feedback-body">
		    <textarea placeholder="请填写详细信息..." v-model="sendDate.content" class="feedback-textare" />
		    </view>
        <view class='feedback-title'>
            <text>地点（必选）：</text>
        </view>
			...
			<form @submit="formSubmit" >
				<view>
					...
					<radio-group class="uni-column" name="location">
						<view class="uni-flex">
						<label>
							<radio value="1" />信息学部</label>
						<label>
							<radio value="2" />文理学部</label></view>
						<view class=" uni-flex">
						<label>
							<radio value="3" />工学部</label>
						<label>
