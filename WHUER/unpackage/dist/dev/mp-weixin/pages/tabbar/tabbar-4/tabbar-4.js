...

{
  ...
  (0, _vuex.mapState)(['isLogin', 'notice'])),
  ...
  (0, _vuex.mapMutations)(['getNotice'])) };exports.default = _default;
...
var render = function() {
  ...
  return _c("view", { staticClass: "page" }, [
    !_vm.isLogin
      ? _c("view", { staticClass: "align" }, [_vm._v("登录以获取通知")])
      : _vm._e(),
    _vm.notice.count == 0
      ? _c("view", { staticClass: "align" }, [_vm._v("暂无通知,下拉以刷新")])
      : _vm._e(),
    _c(
      "view",
      { staticClass: "uni-list" },
      _vm._l(_vm.notice.data, function(item, index) {
        return _c("view", { key: index, staticClass: "uni-list-cell" }, [
          _c(
            "view",
            { staticClass: "uni-list-cell-navigate uni-navigate-right" },
            [_vm._v(_vm._s(item.sender) + " | " + _vm._s(item.nickname))]
          )
        ])
      })
    )
